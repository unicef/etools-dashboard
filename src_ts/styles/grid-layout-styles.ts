...
$_documentContainer.innerHTML = `<dom-module id="grid-layout-styles">
  <template>
    <style>
      .layout-horizontal,
      .layout-vertical {
...
/* This file will be dedicated for 12 columns content layout / with some added custom classes for in between sizes*/
/*
