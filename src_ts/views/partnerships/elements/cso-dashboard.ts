...
// import { CommonGeneral } from '../../../mixins/common-general-mixin';
...
* @customElement
*/
class CsoDashboard extends PolymerElement {
// CommonGeneral(
//   ListFilters(
//     EndpointsMixin(
...
//     <partnership-data id="partnerships" filtered-partnerships="{{filteredPartnerships}}" fire-data-loaded="" active="[[active]]" total-results="{{totalResults}}" on-partnerships-loaded="_requiredDataLoaded" list-data-path="filteredPartnerships" preset-filters="{{presetFilters}}" presets-loaded="{{presetsLoaded}}">
//     </partnership-data>
...
//             <div class="filter">
//               <etools-date-input id\$="datepicker_[[filter.path]]" label="[[filter.filterName]]" placeholder="—" value="{{filter.dateSelected}}" format="D MMM YYYY" on-date-has-changed="_filterDateHasChanged" data-filter-path\$="[[filter.path]]" fire-date-has-changed="" no-init="" show-clear-btn="">
//               </etools-date-input>
//             </div>
//           </template>
//         </template>
...
//         <data-table-column class="col-6 no-header-line" group-heading="blank" transparent="">
...
//             </data-table-column>
//           </data-table-column>
//           <data-table-column class="col-6" group-heading="FUNDS RESERVED &amp; DISBURSED">
...
//             </data-table-column>
//           </data-table-column>
//           <data-table-column class="col-2 no-header-line" group-heading="blank" transparent="">
...
//       <template id="csoListTemplate" items="{{filteredPartnerships}}" filter="{{computeFilter(currentFilter)}}" is="dom-repeat" as="row">
...
//                 <a href="[[baseSite]]/pmp/partners/[[row.partner_id]]/details" app-name="pmp" page="partners" id="[[row.partner_id]]/details" class="title">
//                     [[row.partner_name]]
...
//                   <a href="[[baseSite]]/pmp/interventions/[[row.intervention_id]]/details" app-name="pmp" page="interventions" id="[[row.intervention_id]]/details" class="title">
...
//                   <iron-icon hidden="[[_checkSigned(row.status, row.all_currencies_are_consistent)]]" icon="dash-custom-icons:not-equal" class="blue-icon"></iron-icon>
...
//                   </paper-tooltip>
//                   <iron-icon hidden="[[_checkAllCurrenciesConsistent(row.status, row.all_currencies_are_consistent, row.fr_currencies_are_consistent)]]" icon="dash-custom-icons:1+" class="blue-icon">
//                   </iron-icon>
//                   <paper-tooltip hidden="[[_checkAllCurrenciesConsistent(row.status, row.all_currencies_are_consistent, row.fr_currencies_are_consistent)]]">
...
//                 </span>
//                 <span class="col-data col-5 right-align">
//                   <iron-icon hidden="[[_hideRedIcon(row)]]" icon="dash-custom-icons:not-equal" class="red-icon">
...
//                   <iron-icon hidden="[[!row.multi_curr_flag]]" icon="dash-custom-icons:not-equal" class="blue-icon">
//                   </iron-icon>
//                   <paper-tooltip hidden="[[!row.multi_curr_flag]]">
//                     There are multiple transaction currencies in VISION
//                   </paper-tooltip>
//                   [[_displayDisbursement(row.disbursement, row.multi_curr_flag)]]
//                 </span>
//               </div>
...
//         </data-table-row>
//       </template>
//       <data-table-footer id="csoDashboardFooter" page-size="[[pageSize]]" page-number="[[pageNumber]]" visible-range="{{visibleRange}}" on-page-size-changed="pageSizeChanged" filtered-total-results="[[totalResults]]" on-page-number-changed="pageNumberChanged">
//       </data-table-footer>
//     </div>
// `;
//   }
  ...
  //       case '3':
  //         return ['active', 'ended'].some(eq) && (parseInt(row.days_last_pv) > 180);
  //       case '4':
