...
// export class ViewPersonalized extends connect(store)(
//   // CommonGeneralMixin(
//     LoadingMixin(PersonalizedDataMixin(PolymerElement))) {
//   static get template() {
//     return html`
//       <custom-style>
...
export class ViewPersonalized extends PolymerElement {
  ...
  setEmbedSource() {
    ...
    ` and actionpoints/assigned_to_email eq '${email}'` +
    // ` and actionpoints/assigned_by_email eq '${email}'`
    // ` and trips/supervisor_email eq '${email}'` +
    ` and trips/supervisor_email eq '${email}'`;
