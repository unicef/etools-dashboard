...
//     <div class="paper-material list-panel hact-paper layout  center-center" elevation="1">
...
//               <google-chart id="progVisitsChart" class="viz" type="bar">
//               </google-chart>
//             </div>
...
//             </div>
//             <div class="flex-1 layout-vertical">
//               <google-chart id="spotChecksChart" class="viz" type="bar">
//               </google-chart>
//             </div>
//           </div>
...
//                   <a target="_blank" href="[[schedAuditUrl]]">
...
//                     <a target="_blank" href="[[specialAuditUrl]]">
//                     <iron-icon class="dark" icon="file-download"></iron-icon>
//                   </a>
//                 </div>
//                 <div class="subheading assurance-color">Completed</div>
...
//             <google-chart id="coverageByIpChart" class="coverage-pie" type="pie">
//             </google-chart>
//           </div>
...
//             <google-chart id="coverageCashChart" class="coverage-pie" type="pie">
//             </google-chart>
//           </div>
//         </div>
...
//             <div class="flex-1 layout-horizontal">
//               <div class="assurance-data">
//                 <div class="completed">[[chartData.assurance_coverage.table.0.value]]
//                   <a target="_blank" href="[[notProgVisitsUrl]]">
//                     <iron-icon class="dark" icon="file-download"></iron-icon>
//                   </a>
//                 </div>
...
//                   <a target="_blank" href="[[notSpotChecksUrl]]">
//                     <iron-icon class="dark" icon="file-download"></iron-icon>
//                   </a>
//                 </div>
...
//                     <a target="_blank" href="[[notAssuranceUrl]]">
//                       <iron-icon class="dark" icon="file-download"></iron-icon>
//                     </a>
//                   </div>
...
//           <template is="dom-repeat" items="[[chartData.financial_findings]]">
...
//           </div>
//           <template is="dom-repeat" items="[[chartData.financial_findings_numbers.3.value]]">
//             <div class="layout-horizontal justified audit-line">
...
//           <google-chart id="cash_transfers_amountsChart" class="viz-col" type="column">
//           </google-chart>
//         </div>
...
//       <div class="layout-horizontal">
//         <div class="col-8 component">
//           <google-chart id="cash_transfers_risk_ratingsChart" class="viz-col" type="column">
//           </google-chart>
//         </div>
//         <div class="col-3 component ratings-wrapper layout-vertical">
//           <div class="layout-horizontal justified">
...
//       <div class="paper-material list-panel hact-paper half-paper layout center-center" elevation="1">
//         <div class="hact-title component">
...
//             <google-chart id="cash_transfers_partner_typeChart" class="viz-col" type="column">
//             </google-chart>
//           </div>
...
//       <div class="paper-material hact-paper half-paper layout center-center" elevation="1">
//         <div class="hact-title component">
...
//           <div class="col-40">
//             <google-chart id="spot_checks_completedChart" class="viz-col" type="pie">
//             </google-chart>
//           </div>
//           <div class="flex-1">
...
//         fireEvent(this, 'global-loading', { loadingSource: 'hact-charts', active: true });
//       } else {
//         fireEvent(this, 'global-loading', { loadingSource: 'hact-charts' });
//         this._drawCharts();
//       }
//     }
//   }
...
//   getAssuranceActivitiesBars(entity) {
//     return [
//       ['Data', 'Text', { role: 'annotation' }, 'Count', { role: 'style' }, { role: 'annotation' }],
//       ['', 0, 'Completed', entity.completed,
//         entity.completed >= entity.min_required ? '#1B9C5C' : '#F05454', entity.completed],
//       ['', 0, 'Minimum Required', entity.min_required, '#A7A7A7', entity.min_required]
//     ];
//   }
...
//       const spotChecksData = this.getAssuranceActivitiesBars(spotChecks);
